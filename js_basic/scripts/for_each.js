...
/* for(let i of btn){
    console.log(i)
    i.addEventListener('mouseover',()=>eventColor('#ea2f14',i))
    i.addEventListener('mouseout',()=>eventColor('#fcef91',i))
} */
...
lawAllChk.addEventListener('click',function(){
    ...
    if(lawAllChk.checked == true){//현재(this)선택상태(checked)가 됐다면(true)
